...
- [ ] T028 [US1] Remove manual memoization from `src/app/(public)/account/` (`AccountClient`, `NotificationsSection`, `PasswordSection`, `PreferencesSection`, `ProfileSection`), verifying against the account suites.
