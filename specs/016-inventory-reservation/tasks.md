...
- [ ] T008 Refresh `scripts/sql/bootstrap-drizzle-initial.sql` so `npm run db:bootstrap` applies the new schema to an empty database (constitution workflow gate 6).
