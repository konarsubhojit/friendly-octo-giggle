...
- `playwright.config.ts` still probes a `/en/shop` URL that no longer exists in the route tree; fixing the suite belongs to `013-e2e-in-continuous-integration`, and T045 depends on it.
