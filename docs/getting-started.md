...
# Image storage (default: Vercel Blob; set STORAGE_PROVIDER=s3 for MinIO/AWS/etc. or r2 for Cloudflare preset)
...
│   │   │   ├── upload/        # Image upload (Vercel Blob or S3-compatible)
│   │   │   └── health/        # Health check
