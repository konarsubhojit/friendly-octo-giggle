...
describe("orderStatusVariant", () => {
  it("maps PENDING to warning", () => expect(orderStatusVariant("PENDING")).toBe("warning"));
  it("maps PROCESSING to info", () => expect(orderStatusVariant("PROCESSING")).toBe("info"));
  it("maps SHIPPED to primary", () => expect(orderStatusVariant("SHIPPED")).toBe("primary"));
  it("maps DELIVERED to success", () => expect(orderStatusVariant("DELIVERED")).toBe("success"));
  it("maps CANCELLED to error", () => expect(orderStatusVariant("CANCELLED")).toBe("error"));
  it("maps unknown status to neutral", () => expect(orderStatusVariant("UNKNOWN")).toBe("neutral"));
  it("is case-insensitive", () => expect(orderStatusVariant("delivered")).toBe("success"));
});

describe("roleVariant", () => {
  it("maps ADMIN to primary", () => expect(roleVariant("ADMIN")).toBe("primary"));
  it("maps CUSTOMER to success", () => expect(roleVariant("CUSTOMER")).toBe("success"));
  it("is case-insensitive for admin", () => expect(roleVariant("admin")).toBe("primary"));
});
...
describe("AuthRequiredState", () => {
  ...
  it("renders custom message", () => {
    render(<AuthRequiredState callbackUrl="/orders" message="Sign in to view your orders." />);
...
describe("AlertBanner", () => {
  ...
  it("applies success variant styles", () => {
    const { container } = render(<AlertBanner message="Saved!" variant="success" />);
