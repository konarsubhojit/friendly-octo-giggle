...
import GlobalError from '@/app/(public)/error'
import OrdersError from '@/app/(public)/orders/error'
import AdminError from '@/app/admin/error'
import CartError from '@/app/(public)/cart/error'
import ProductsError from '@/app/(public)/products/error'
