...
ALTER TABLE "CheckoutRequest" ADD COLUMN "paymentProvider" "PaymentProvider" NOT NULL;--> statement-breakpoint
ALTER TABLE "CheckoutRequest" ADD COLUMN "paymentOrderId" text NOT NULL;--> statement-breakpoint
ALTER TABLE "CheckoutRequest" ADD COLUMN "paymentTransactionId" text NOT NULL;--> statement-breakpoint
ALTER TABLE "CheckoutRequest" ADD COLUMN "paymentSignature" text NOT NULL;--> statement-breakpoint
...
CREATE INDEX "CheckoutRequest_paymentTransactionId_idx" ON "CheckoutRequest" USING btree ("paymentTransactionId");--> statement-breakpoint
CREATE INDEX "Order_paymentStatus_idx" ON "Order" USING btree ("paymentStatus");--> statement-breakpoint
CREATE INDEX "Order_paymentTransactionId_idx" ON "Order" USING btree ("paymentTransactionId");