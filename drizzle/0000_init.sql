...
ALTER TABLE "ProductShare" ADD CONSTRAINT "ProductShare_variationId_ProductVariation_id_fk" FOREIGN KEY ("variationId") REFERENCES "public"."ProductVariation"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
