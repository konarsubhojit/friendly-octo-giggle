...
export default function Footer() {
  return (
    ...
    >
      ...
      <div className="absolute bottom-8 left-6 opacity-15" aria-hidden="true">
        <FlowerAccent className="w-10 h-10" />
      </div>

      <div className="relative z-10 mx-auto w-full max-w-[96rem] px-4 sm:px-6 lg:px-8 xl:px-10 2xl:px-12">
        ...
        <div className="text-center pt-4">
          <p className="text-[var(--text-secondary)] text-sm">
            © 2026 The Kiyon Store. Handmade with love. All rights reserved. 🧶
          </p>
        </div>
      </div>
    </footer>
