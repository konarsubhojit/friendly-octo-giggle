        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-4">
            {(['ci1', 'ci2', 'ci3'] as const).map((id) => (
              ...
              >
                <div className="w-20 h-20 bg-[var(--accent-peach)] rounded-lg animate-pulse shrink-0" />
                <div className="flex-1 space-y-2">
                  ...
                  <div className="h-4 w-1/4 bg-[var(--accent-peach)] rounded animate-pulse" />
                </div>
              </div>
            ))}
          </div>
          ...
          <div className="p-6 bg-[var(--surface)] rounded-xl border border-[var(--border-warm)] h-fit space-y-4">
            <div className="h-6 w-36 bg-[var(--accent-peach)] rounded animate-pulse" />
