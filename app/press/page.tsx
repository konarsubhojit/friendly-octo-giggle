    ...
    <div className="min-h-screen bg-warm-gradient">
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pt-28 pb-16">
        ...
        <section className="bg-[var(--surface)]/80 backdrop-blur-sm rounded-2xl shadow-warm border border-[var(--border-warm)] p-8 mb-8">
          <h2 className="text-2xl font-semibold text-[var(--foreground)] mb-6">Press Releases</h2>
        ...
        <section className="bg-[var(--surface)]/80 backdrop-blur-sm rounded-2xl shadow-warm border border-[var(--border-warm)] p-8">
          <h2 className="text-xl font-semibold text-[var(--foreground)] mb-4">Media Inquiries</h2>
          <p className="text-[var(--text-secondary)] mb-4">
            For press inquiries, interview requests, or media kit downloads, please contact our communications team.
          </p>
          <Link
            href="/contact"
            className="inline-block bg-gradient-to-r from-[var(--accent-warm)] to-[var(--accent-rose)] text-white px-6 py-3 rounded-xl font-semibold hover:from-[var(--accent-rose)] hover:to-[var(--accent-warm)] transition-all duration-300 shadow-md hover:shadow-lg"
          >
            Contact Press Team
          </Link>
        </section>
