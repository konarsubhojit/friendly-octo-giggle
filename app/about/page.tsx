  ...
  return (
    <div className="min-h-screen bg-warm-gradient">
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pt-28 pb-16">
        <h1 className="text-4xl font-bold text-[#4a3728] mb-4 animate-fade-in-up">About Us</h1>
        <p className="text-[#7a6355] text-lg mb-12 animate-fade-in-up animation-delay-100">Your trusted online shopping destination.</p>

        <section className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-warm border border-[#f0d5c0] p-8 mb-8 animate-fade-in-up animation-delay-200">
          <h2 className="text-2xl font-semibold text-[#4a3728] mb-4">Our Mission</h2>
        ...
        <section className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-warm border border-[#f0d5c0] p-8 mb-8 animate-fade-in-up animation-delay-300">
          <h2 className="text-2xl font-semibold text-[#4a3728] mb-4">Our Story</h2>
        ...
        <section className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-warm border border-[#f0d5c0] p-8 mb-8 animate-fade-in-up animation-delay-400">
          <h2 className="text-2xl font-semibold text-[#4a3728] mb-6">Our Values</h2>
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
            <div className="text-center">
              <div className="w-12 h-12 bg-[#fde8d8] rounded-xl flex items-center justify-center mx-auto mb-3">
                <svg className="w-6 h-6 text-[#d4856b]" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
              </div>
              <h3 className="font-semibold text-[#4a3728] mb-2">Quality First</h3>
            ...
            <div className="text-center">
              ...
              <h3 className="font-semibold text-[#4a3728] mb-2">Customer Focus</h3>
              <p className="text-sm text-[#7a6355]">Your satisfaction is our top priority, every step of the way.</p>
            </div>
            <div className="text-center">
              <div className="w-12 h-12 bg-[#d4e4c4] rounded-xl flex items-center justify-center mx-auto mb-3">
                <svg className="w-6 h-6 text-[#7a9e5e]" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" />
                </svg>
              </div>
              <h3 className="font-semibold text-[#4a3728] mb-2">Fast & Reliable</h3>
              <p className="text-sm text-[#7a6355]">Quick delivery and dependable service you can count on.</p>
            </div>
          </div>
        </section>

        <section className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-warm border border-[#f0d5c0] p-8 animate-fade-in-up animation-delay-500">
          <h2 className="text-2xl font-semibold text-[#4a3728] mb-4">The Team</h2>
          <p className="text-[#7a6355] leading-relaxed">
