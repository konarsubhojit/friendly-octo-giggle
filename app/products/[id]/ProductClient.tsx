...
function VariationButton({ variation, isSelected, formatPrice, onSelect }: VariationButtonProps) {
  const className = isSelected
    ...
    : 'p-4 border-2 rounded-xl transition-all duration-300 border-gray-300 bg-white dark:bg-gray-800 dark:border-gray-600 hover:border-blue-400 hover:shadow-md hover:scale-105';
  ...
  return (
    <button key={variation.id} onClick={() => onSelect(variation)} className={className}>
      ...
      <div className="text-xs text-gray-600 dark:text-gray-400 mt-1">{variation.name}</div>
            ...
            {effectiveStock > 0 && (
              <div className="bg-white/80 backdrop-blur-lg rounded-2xl shadow-xl border border-white/50 p-8">
                ...
                <div className="mb-5">
                  ...
                  <div className="flex items-center gap-3">
                    <button
                      ...
                      className="w-10 h-10 rounded-lg border-2 border-gray-200 bg-white dark:bg-gray-700 dark:border-gray-600 dark:text-gray-200 flex items-center justify-center text-gray-600 hover:border-blue-400 hover:text-blue-600 dark:hover:border-blue-400 dark:hover:text-blue-400 transition-colors font-bold text-lg"
                    >
                      -
                    </button>
                    <input
                      ...
                      className="w-16 text-center px-2 py-2 border-2 border-gray-200 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent font-semibold"
                    />
                    <button
                ...
                <div className="flex gap-3">
                  ...
                  <Link
                    href="/cart"
                    className="flex-shrink-0 bg-gray-100 hover:bg-gray-200 dark:bg-gray-700 dark:hover:bg-gray-600 dark:text-gray-100 text-gray-700 px-5 py-4 rounded-xl font-bold transition-all duration-300 flex items-center gap-2"
                  >
                    <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
