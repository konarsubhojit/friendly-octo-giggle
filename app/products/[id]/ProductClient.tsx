...
function ProductImageSection({ currentImage, productName }: ProductImageSectionProps) {
  return (
...
function ProductInfoCard({ product, formatPrice, effectivePrice, selectedVariation, setSelectedVariation, effectiveStock }: ProductInfoCardProps) {
  return (
...
function AddToCartSection({ error, cartSuccess, quantity, setQuantity, effectiveStock, effectivePrice, addingToCart, handleAddToCart, formatPrice }: AddToCartSectionProps) {
  return (
    ...
    <div className="min-h-screen bg-warm-gradient">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-28 pb-16">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          <ProductImageSection currentImage={currentImage} productName={product.name} />
