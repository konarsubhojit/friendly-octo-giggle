...
- 001-cozy-shop-ui: Added TypeScript 5.9, Next.js 16.1.6 (App Router), React 19.2.4 + Tailwind CSS v4.1 (CSS-first config), next/font/google (Playfair Display + Nunito), Redux Toolkit 2.11, NextAuth v5
- 001-cozy-shop-ui: Added TypeScript 5.9 on Next.js 16.1.6 (App Router) + React 19.2.4, Tailwind CSS v4.1, next-auth v5, Redux Toolkit 2.11
