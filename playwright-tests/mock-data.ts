...
export const MOCK_PRODUCTS = [
  {
    ...
    description:
      "A beautiful bouquet of hand-knitted flowers in vibrant colours, perfect for home décor or as a gift.",
    price: 1499,
    image:
  ...
  },
  {
    ...
    description:
      "Handcrafted macramé wall hanging with intricate knotwork. Adds a bohemian touch to any room.",
    price: 2299,
    image:
  ...
  },
  {
    ...
    description:
      "Soft, warm muffler hand-knitted from premium wool. Available in multiple colour options.",
    price: 899,
    image:
  ...
  },
  {
    ...
    description:
      "Cute set of 3 hand-crocheted rose keyrings — a perfect daily-carry charm or gift set.",
    price: 349,
    image:
  ...
  },
  {
    ...
    description:
      "Reusable hand warmer pouch filled with natural grain, knitted in a cosy cable-stitch pattern.",
    price: 599,
    image:
  ...
  },
  {
    ...
    description:
      "Lightweight crochet bucket hat for sunny days. Hand-made with 100% cotton yarn.",
    price: 1199,
    image:
    ...
    items: [
      {
        ...
        price: 1999,
        customizationNote:
          'Birthday gift — add a card saying "Happy Birthday Maa!"',
        product: {
          id: "prd0001",
          name: "Hand-knitted Flower Bouquet",
          image:
